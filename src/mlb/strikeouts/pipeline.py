"""MLB strikeouts pipeline adapter for the core sport/stat contract."""
...
class MlbStrikeoutsPipeline(SportStatPipeline):
    """Adapter that preserves MLB behavior behind the modular contract."""
    ...
    def simulate(
        ...
        return run_strikeouts_pipeline(config=config, retrain=self.retrain)
